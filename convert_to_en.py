...
def bs_to_en(df):
    ...
    for i,j in enumerate(df['شرح']):
        if j == 'دارایی‌ها' or j == 'دارايي‌ها' or j == 'دارایی‌‌ها' or j == 'دارایی ها':
            df['شرح'][i] = 'Assets'
        ...
        elif j == 'دارایی‌های ثابت مشهود' or j == 'دارايي‌هاي ثابت مشهود' or j == 'دارایی‌هاي ثابت مشهود':
            df['شرح'][i] = 'Tangible Fixed Assets'
        elif j == 'سرمایه‌گذاری در املاک' or j == 'سرمايه‌گذاري در املاک' or j == 'سرمایه گذاری در املاک':
            df['شرح'][i] = 'Investment in Properties'
        elif j == 'دارایی‌های نامشهود' or j == 'دارايي‌هاي نامشهود' or j == 'دارایی‌های نا مشهود' or j == 'دارایی‌هاي نا مشهود':
        ...
        elif j == 'سایر دارایی‌ها' or j == 'ساير دارايي‌ها' or j == 'ساير دارایی‌ها':
        ...
        elif j == 'صرف سهام' or j == 'صرف (کسر) سهام' or j == 'اندوخته صرف سهام':
            df['شرح'][i] = 'Share repurchase'
        elif j == 'صرف سهام خزانه':
            df['شرح'][i] = 'Treasury Share repurchase'
        elif j == 'اندوخته قانونی' or j == 'اندوخته قانوني' or j == 'سپرده قانونی':
            df['شرح'][i] = 'Legal Reserve'
        elif j == 'ساير اندوخته‌ها' or j == 'سایر اندوخته‌ها':
            df['شرح'][i] = 'Other Reserves'
        elif j == 'مازاد تجدیدارزيابی دارایی‌ها' or j == 'مازاد تجدید ارزیابی دارایی‌ها' or j == 'مازاد تجديدارزيابي دارايي‌ها' or j == 'مازاد تجديد ارزيابي دارايي‌ها':
            df['شرح'][i] = 'Revaluation Surplus'
        elif j == 'تفاوت تسعیر ارز عملیات خارجی' or j == 'تفاوت تسعیر ناشی از تبدیل به واحد پول گزارشگری' or j == 'تفاوت تسعير ارز عمليات خارجي' or j == 'تفاوت تسعیر ارز':
        ...
        elif j == 'سود سهام پرداختنی' or j == 'سود سهام پرداختني' or j == 'سود سهام پرداختی':
        ...
        elif j == 'جمع بدهی‌ها' or j == 'جمع بدهي‌ها' or j == 'جمع بدهی ها':
            df['شرح'][i] = 'Total Liabilities'
        elif j == 'جمع حقوق مالکانه و بدهی‌ها' or j == 'جمع بدهی‌ها و حقوق صاحبان سهام' or j == 'جمع حقوق مالکانه و بدهي‌ها' or j == 'جمع بدهي‌ها و حقوق مالکانه' or j == 'جمع بدهی‌ها و حقوق مالکانه':
        ...
        elif j == 'مطالبات از بانک ها و ساير موسسات اعتباري':
            df['شرح'][i] = 'Claims from banks and other financial institutions'
        elif j == 'مطالبات از دولت':
            df['شرح'][i] = 'Claims from the government'
        elif j == 'تسهيلات اعطايي و مطالبات از اشخاص دولتي':
            df['شرح'][i] = 'Loans granted and claims from government entities'
        elif j == 'تسهيلات اعطايي و مطالبات از اشخاص غير دولتي':
            df['شرح'][i] = 'Loans granted and claims from non-government entities'
        elif j == 'سرمایه‌گذاری در سهام و ساير اوراق بهادار':
            df['شرح'][i] = 'Investments in stocks and other securities'
        elif j == 'مطالبات از شرکت‌های فرعی و وابسته':
            df['شرح'][i] = 'Claims from subsidiary and affiliated companies'
        elif j == 'ساير حسابهاي دريافتني':
            df['شرح'][i] = 'Other receivable accounts'
        elif j == 'بدهي به بانكها و ساير موسسات اعتباري':
            df['شرح'][i] = 'Debt to banks and other financial institutions'
        elif j == 'سپرده‌هاي مشتریان':
            df['شرح'][i] = 'Customer deposits'
        elif j == 'اوراق بدهی':
            df['شرح'][i] = 'Debt securities'
        elif j == 'ذخيره ماليات عملکرد':
            df['شرح'][i] = 'Income tax reserve'
        elif j == 'ذخاير و ساير بدهی‌ها':
            df['شرح'][i] = 'Reserves and other liabilities'
        elif j == 'ذخيره مزاياي پايان خدمت و تعهدات بازنشستگی کارکنان':
            df['شرح'][i] = 'Reserves for end-of-service benefits and employee retirement commitments'
        elif j == 'جمع بدهی های قبل از حقوق صاحبان سپرده های سرمایه گذاری':
            df['شرح'][i] = "otal liabilities before shareholders' equity of investment deposits"
        elif j == 'حقوق صاحبان سپرده‌های سرمایه‌گذاری':
            df['شرح'][i] = "Shareholders' equity of investment deposits"
        # else:
        #     df['شرح'][i] = g.translate(j).text
...
def cf_to_en(df):
    df.columns = df.columns.astype(str)
    for i,j in enumerate(df['شرح']):
        if j == 'جریان­‌های نقدی حاصل از فعالیت‌های عملیاتی:' or j == 'جريان­هاي نقدي حاصل از فعاليت‌هاي عملياتي:' or j == 'فعالیت‌های عملیاتی' or j == 'جریان­های نقدی حاصل از فعاليت‌هاي عملياتي:':
            df['شرح'][i] = 'Operating Activities'
        elif j == 'نقد حاصل از عملیات' or j == 'نقد حاصل از عمليات':
            df['شرح'][i] = 'Net Income'
        elif j == 'پرداخت‌های نقدی بابت مالیات بر درآمد' or j == 'پرداخت‌هاي نقدي بابت ماليات بر درآمد' or j == 'مالیات بر درآمد پرداختی':
            df['شرح'][i] = 'Cash payments for income taxes'
        elif j == 'جریان ‌خالص ‌ورود‌ (خروج) ‌نقد حاصل از فعالیت‌های ‌عملیاتی' or j == 'جريان ‌خالص ‌ورود‌ (خروج) ‌نقد حاصل از فعاليت‌هاي ‌عملياتي' or j == 'جریان خالص ورود (خروج) وجه نقد ناشی از فعالیت‌های عملیاتی':
            df['شرح'][i] = 'Net cash provided by (used in) operating activities'
        elif j == 'جریان‌­های نقدی حاصل از فعالیت‌های سرمایه‌گذاری:' or j == 'جريان­هاي نقدي حاصل از فعاليت‌هاي سرمايه‌گذاري:' or j == 'جریان های نقدی حاصل از فعاليت‌هاي سرمايه‌گذاري:' or j == 'فعالیت‌های سرمایه گذاری' or j == 'فعاليت‌هاي سرمایه‌گذاری':
            df['شرح'][i] = 'Cash flows from investing activities'
        elif j == 'دریافت‌های نقدی حاصل از فروش دارایی‌های ثابت مشهود' or j == 'دريافت‌هاي نقدي حاصل از فروش دارايي‌هاي ثابت مشهود' or j == 'دریافت‌های نقدی حاصل از فروش دارايي‌هاي ثابت مشهود' or j == 'وجوه دریافتی بابت فروش دارایی‌های ثابت مشهود' or j == 'وجوه دریافتی بابت فروش دارایی‌هاي ثابت مشهود':
            df['شرح'][i] = 'Cash receipts from the sale of tangible fixed assets'
        elif j == 'پرداخت‌های نقدی برای خرید دارایی‌های ثابت مشهود' or j == 'پرداخت‌هاي نقدي براي خريد دارايي‌هاي ثابت مشهود' or j == 'پرداخت‌های نقدی برای خرید دارايي‌هاي ثابت مشهود' or j == 'وجوه پرداختی بابت خرید دارایی‌های ثابت مشهود' or j == 'وجوه پرداختي بابت تحصیل دارایی‌هاي ثابت مشهود':
            df['شرح'][i] = 'Cash payments for the purchase of tangible fixed assets'
        elif j == 'دریافت‌های نقدی حاصل از فروش دارایی‌های نگهداری‌شده برای فروش' or j == 'دريافت‌هاي نقدي حاصل از فروش دارايي‌هاي غيرجاري نگهداري‌شده براي فروش' or j == 'دریافت‌های نقدی حاصل از فروش دارايي‌هاي غیرجاری نگهداری‌شده برای فروش' or j == 'وجوه دریافتی بابت فروش دارایی‌های نگهداری شده برای فروش':
            df['شرح'][i] = 'Cash receipts from the sale of held-for-sale assets'
        elif j == 'دریافت‌های نقدی حاصل از فروش دارایی‌های نامشهود' or j == 'دريافت‌هاي نقدي حاصل از فروش دارايي‌هاي نامشهود' or j == 'دریافت‌های نقدی حاصل از فروش دارايي‌هاي ثابت نامشهود' or j == 'وجوه دریافتی بابت فروش دارایی‌های نامشهود' or j == 'وجوه دریافتی بابت فروش دارایی‌هاي نامشهود':
            df['شرح'][i] = 'Cash receipts from the sale of intangible assets'
        elif j == 'پرداخت‌های نقدی برای خرید دارایی‌های نامشهود' or j == 'پرداخت‌هاي نقدي براي خريد دارايي‌هاي نامشهود' or j == 'پرداخت‌های نقدی برای خرید دارايي‌هاي ثابت نامشهود' or j == 'وجوه پرداختی بابت خرید دارایی‌های نامشهود‌' or j == 'وجوه پرداختي بابت تحصیل دارایی‌هاي نامشهود':
            df['شرح'][i] = 'Cash payments for the purchase of intangible assets'
        elif j == 'دریافت‌های نقدی حاصل از فروش سرمايه‌گذاری‌های بلندمدت' or j == 'دريافت‌هاي نقدي حاصل از فروش سرمايه‌گذاري‌هاي بلندمدت' or j == 'دریافت های نقدی حاصل از فروش سرمایه گذاری بلند مدت' or j == 'وجوه دریافتی بابت فروش سرمایه‌گذاری‌های بلندمدت':
            df['شرح'][i] = 'Cash receipts from the sale of long-term investments'
        elif j == 'پرداخت‌های نقدی برای تحصیل سرمايه‌گذاری‌های بلندمدت' or j == 'پرداخت‌هاي نقدي براي تحصيل سرمايه‌گذاري‌هاي بلندمدت' or j == 'پرداخت های نقدی برای تحصیل سرمایه گذاری بلند مدت' or j == 'وجوه پرداختی بابت خرید سرمایه‌گذاری‌های بلندمدت':
            df['شرح'][i] = 'Cash payments for long-term investments'
        elif j == 'دریافت‌های نقدی حاصل از فروش سرمایه‌گذاری در املاک' or j == 'دريافت‌هاي نقدي حاصل از فروش سرمايه‌گذاري در املاک' or j == 'دریافت های نقدی حاصل از فروش سرمایه گذاری در املاک' or j == 'وجوه دریافتی بابت فروش سرمایه‌گذاری‌ در املاک' or j == 'وجوه دریافتی بابت فروش املاک و مستغلات غیر عملیاتی':
            df['شرح'][i] = 'Cash receipts from the sale of real estate investments'
        elif j == 'پرداخت‌های نقدی برای تحصیل سرمایه‌گذاری در املاک' or j == 'پرداخت‌هاي نقدي براي تحصيل سرمايه‌گذاري‌ در املاک' or j == 'پرداخت های نقدی برای تحصیل سرمایه گذاری در املاک' or j == 'وجوه پرداختی بابت خرید سرمایه‌گذاری در املاک' or j == 'وجوه پرداختي بابت تحصیل املاک و مستغلات غیر عملیاتی':
            df['شرح'][i] = 'Cash payments for real estate investments'
        elif j == 'دریافت‌های نقدی حاصل از فروش سرمايه‌گذاری‌های کوتاه‌مدت' or j == 'دريافت‌هاي نقدي حاصل از فروش سرمايه‌گذاري‌هاي کوتاه‌مدت' or j == 'دریافت های نقدی حاصل از فروش سرمایه گذاری کوتاه مدت' or j == 'وجوه دریافتی بابت فروش سرمایه‌گذاری‌های کوتاه‌مدت':
            df['شرح'][i] = 'Cash receipts from the sale of short-term investments'
        elif j == 'پرداخت‌های نقدی برای تحصیل سرمایه‌گذاری‌های کوتاه‌مدت' or j == 'پرداخت‌هاي نقدي براي تحصيل سرمايه‌گذاري‌هاي کوتاه‌مدت' or j == 'پرداخت های نقدی برای تحصیل سرمایه گذاری کوتاه مدت' or j == 'وجوه پرداختی بابت خرید سرمایه‌گذاری‌های کوتاه‌مدت':
            df['شرح'][i] = 'Cash payments for short-term investments'
        elif j == 'پرداخت های نقدی بابت تسهیلات اعطایی به دیگران' or j == 'پرداخت‌هاي نقدي بابت تسهيلات اعطايي به ديگران' or j == 'پرداخت های نقدی برای تسهیلات اعطایی به دیگران' or j == 'تسهیلات اعطایی به اشخاص':
            df['شرح'][i] = 'Cash payments for loans granted to others'
        elif j == 'دریافت‌های نقدی حاصل از استرداد تسهیلات اعطایی به دیگران' or j == 'دريافت‌هاي نقدي حاصل از استرداد تسهيلات اعطايي به ديگران' or j == 'دریافت های نقدی حاصل از استرداد تسهیلات اعطایی به دیگران' or j == 'استرداد تسهیلات اعطایی به اشخاص':
            df['شرح'][i] = 'Cash receipts from the repayment of loans granted to others'
        elif j == 'دریافت‌های نقدی حاصل از سود تسهیلات اعطایی به دیگران' or j == 'دريافت‌هاي نقدي حاصل از سود تسهيلات اعطايي به ديگران' or j == 'دریافت های نقدی حاصل از سود تسهیلات اعطایی به دیگران':
            df['شرح'][i] = 'Cash receipts from interest on loans granted to others'
        elif j == 'دریافت‌های نقدی حاصل از سود‌ سهام' or j == 'دريافت‌هاي نقدي حاصل از سود‌ سهام' or j == 'دریافت های نقدی حاصل از سود سهام':
            df['شرح'][i] = 'Cash receipts from dividend income'
        elif j == 'دریافت‌های نقدی حاصل از سود سایر سرمایه‌گذاری‌ها' or j == 'دريافت‌هاي نقدي حاصل از سود ساير سرمايه‌گذاري‌ها' or j == 'دریافت های نقدی حاصل از سود سرمایه گذاری ها' or j == 'سود دریافتی بابت سایر سرمایه‌گذاری‌ها':
            df['شرح'][i] = 'Cash receipts from other investment income'
        elif j == 'جريان خالص ورود (خروج) نقد حاصل از فعاليت‌های سرمایه‌گذاری' or j == 'جريان خالص ورود (خروج) نقد حاصل از فعاليت‌هاي سرمايه‌گذاري' or j == 'جریان خالص ورود (خروج) وجه نقد ناشی از فعالیت‌های سرمایه‌گذاری' or j == 'جريان خالص ورود (خروج) وجه نقد ناشی از فعاليت‌هاي سرمایه‌گذاری':
            df['شرح'][i] = 'Net cash provided by (used in) investing activities'
        elif j == 'جريان خالص ورود (خروج) نقد قبل از فعالیت‌های تامین مالی' or j == 'جريان خالص ورود (خروج) نقد قبل از فعاليت‌هاي تامين مالي' or j == 'جریان خالص ورود (خروج) وجه نقد قبل از فعالیت‌های تأمین مالی' or j == 'جريان خالص ورود (خروج) وجه نقد قبل از فعالیت‌های تامین مالی':
            df['شرح'][i] = 'Net cash provided by (used in) operating activities before financing activities'
        elif j == 'جریان­‌های نقدی حاصل از فعالیت‌های تامین مالی:' or j == 'جريان­هاي نقدي حاصل از فعاليت‌هاي تامين مالي:' or j == 'جریان های نقدی حاصل از فعاليت‌هاي تامين مالي:' or j == 'فعالیت‌های تأمین مالی' or j == 'فعاليت‌هاي تأمين مالي':
            df['شرح'][i] = 'Cash flows from financing activities'
        elif j == 'دریافت‌های نقدی حاصل از افزايش سرمايه' or j == 'دريافت‌هاي نقدي حاصل از افزايش سرمايه' or j == 'وجوه دریافتی حاصل از افزایش سرمایه':
        ...
        elif j == 'دریافت‌های نقدی حاصل از فروش سهام خزانه' or j == 'دريافت‌هاي نقدي حاصل از فروش سهام خزانه' or j == 'وجوه دریافتی حاصل از فروش سهام خزانه' or j == 'وجوه دریافتی بابت فروش سهام خزانه':
            df['شرح'][i] = 'Cash receipts from the sale of treasury shares'
        elif j == 'پرداخت‌های نقدی برای خرید سهام خزانه' or j == 'پرداخت‌هاي نقدي براي خريد سهام خزانه' or j == 'وجوه پرداختی بابت خرید سهام خزانه':
            df['شرح'][i] = 'Cash payments for the purchase of treasury shares'
        elif j == 'دریافت‌های نقدی حاصل از تسهيلات' or j == 'دريافت‌هاي نقدي حاصل از تسهيلات' or j == 'وجوه دریافتی حاصل از استقراض':
            df['شرح'][i] = 'Cash receipts from facilities'
        elif j == 'پرداخت‌های نقدی بابت اصل تسهيلات' or j == 'پرداخت‌هاي نقدي بابت اصل تسهيلات' or j == 'بازپرداخت اصل استقراض':
            df['شرح'][i] = 'Cash payments for principal of facilities'
        elif j == 'پرداخت‌های نقدی بابت سود تسهيلات' or j == 'پرداخت‌هاي نقدي بابت سود تسهيلات' or j == 'سود پرداختی بابت استقراض':
        ...
        elif j == 'پرداخت‌های نقدی بابت سود سهام' or j == 'پرداخت‌هاي نقدي بابت سود سهام' or j == 'سود سهام پرداختی':
            df['شرح'][i] = 'Cash payments for dividend income on shares'
        elif j == 'جريان خالص ورود (خروج) نقد حاصل از فعالیت‌های تامين مالی' or j == 'جريان خالص ورود (خروج) نقد حاصل از فعاليت‌هاي تامين مالي' or j == 'جریان خالص ورود (خروج) وجه نقد ناشی از فعالیت‌های تأمین مالی':
            df['شرح'][i] = 'Net cash provided by (used in) financing activities'
        elif j == 'خالص افزايش (کاهش) در موجودی نقد' or j == 'خالص افزايش (کاهش) در موجودي نقد' or j == 'خالص افزایش (کاهش) در موجودی نقد':
            df['شرح'][i] = 'Net increase (decrease) in cash balance'
        elif j == 'مانده موجودی نقد در ابتدای سال' or j == 'مانده موجودي نقد در ابتداي سال' or j == 'موجودی نقد در ابتدای دوره':
            df['شرح'][i] = 'Cash balance at the beginning of the year'
        elif j == 'تاثير تغييرات نرخ ارز' or j == 'تاثير تغييرات نرخ ارز' or j == 'تآثیر تغییرات نرخ ارز':
            df['شرح'][i] = 'Effects of exchange rate changes'
        elif j == 'مانده موجودي نقد در پايان سال' or j == 'مانده موجودی نقد در پايان سال' or j == 'مانده موجودی نقد در پايان دوره' or j == 'موجودی نقد در پایان دوره':
            df['شرح'][i] = 'Cash balance at the end of the year'
        elif j == 'معاملات غیرنقدی' or j == 'معاملات غيرنقدي' or j == 'مبادلات غیرنقدی':
            df['شرح'][i] = 'Non-cash transactions'
        elif j == 'جریان خالص ورود (خروج) وجه نقد ناشی از فعالیت‌های عملیاتی - عادی':
            df['شرح'][i] = 'Net cash provided by (used in) operating activities - Ordinary'
        elif j == 'جریان خالص ورود (خروج) وجه نقد ناشی از فعالیت‌های عملیاتی - استثنایی':
            df['شرح'][i] = 'Net cash provided by (used in) operating activities - Extraordinary'
        elif j == 'بازده سرمایه‌گذاری‌ها و سود پرداختی بابت تأمین مالی':
            df['شرح'][i] = 'Investment returns and interest paid for financing'
        elif j == 'جریان خالص ورود (خروج) وجه نقد ناشی از بازده سرمایه‌گذاری‌ها و سود پرداختی بابت تأمین مالی':
            df['شرح'][i] = 'Net cash inflow (outflow) from investment returns and interest paid for financing'
        # else:
        #     df['شرح'][i] = g.translate(j).text
    # df.drop(0,axis=0,inplace=True)
    df_col = []
...
def is_to_en(df):
    ...
    for i,j in enumerate(df['شرح']):
        if j == 'سود (زیان) خالص':
        ...
        elif j == 'سود (زیان) پایه هر سهم ناشی از عملیات متوقف ‌شده' or j == 'سود (زیان) پایه هر سهم ناشی از عملیات متوقف‌ شده' or j == 'سود (زیان) تقلیل یافته هر سهم ناشی از عملیات متوقف ‌شده':
        ...
        elif j == 'سود (زیان) انباشته ابتدای دوره تعدیل‌شده' or j == 'سود (زیان) انباشته ابتدای دوره تعدیل ‌شده':
            ...
            df['شرح'][i] = 'Capital'
        elif j == 'بهاى تمام شده درآمدهای عملیاتی' or j == 'بهای تمام ‌شده درآمدهای عملیاتی':
            df['شرح'][i] = 'Cost of goods sold for operating income'
        elif j == 'سود (زيان) ناخالص' or j == 'سود (زیان) ناخالص':
